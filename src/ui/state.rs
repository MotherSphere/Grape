    ...
    pub fn update(&mut self, message: UiMessage) {
        match message {
            UiMessage::ToggleLogoMenu => {
                self.logo_menu_open = !self.logo_menu_open;
            }
            UiMessage::OpenPlaylistWindow => {
                self.playlist_window_open = true;
                self.logo_menu_open = false;
            }
            UiMessage::CloseOverlays => {
                self.logo_menu_open = false;
