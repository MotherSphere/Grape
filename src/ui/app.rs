        ...
        let privacy_content = || {
            column![
                ...
                row![
                    ...
                    controls(action_button("Effacer", UiMessage::ClearHistory)),
                ]
                .align_items(Alignment::Center)
                .spacing(12),
            ]
        ...
        let advanced_content = || {
            column![
                ...
                row![
                    ...
                    controls(action_button("Ouvrir", UiMessage::OpenLogsFolder)),
                ]
                .align_items(Alignment::Center)
                .spacing(12),
                row![
                    setting_label("Réindexer la bibliothèque", "Reconstruit l'index local."),
                    controls(action_button("Réindexer", UiMessage::ReindexLibrary)),
                ]
                .align_items(Alignment::Center)
                .spacing(12),
                row![
                    ...
                    controls(action_button("Réinitialiser", UiMessage::ResetPreferences)),
                ]
                .align_items(Alignment::Center)
                .spacing(12),
            ]
